...
test('Viewing on stock: GET request to /api/stock-prices/',function(done){
    chai.request(server)
...
test('Viewing one stock and liking it: GET request to /api/stock-prices',function(done){
    ...
    assert.isObject(res.body,'Response should be an object !!');
    assert.property(res.body,'stockData','Response should have stockData')
    assert.property(res.body.stockData,'Stock data should have a symbol');
    assert.property(res.body.stockData,'price','Stock data should have a price');
    assert.equal(res.body.stockData.symbol,'AAPL','Stock symbol should be AAPL');
...
test('Viewing the same stock and liking it again: GET request to /api/stock-prices/', function(done) {
    chai.request(server)
      ...
      .end(function(err, res) {
        ...
        assert.equal(res.body.stockData.symbol, 'GOOG', 'Stock symbol should be GOOG');
